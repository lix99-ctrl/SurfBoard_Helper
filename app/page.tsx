  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="border-b border-gray-100 py-4 px-6 max-w-5xl mx-auto flex justify-between items-center">
        <span className="font-extrabold tracking-tight text-lg">THE BOARDROOM APP</span>
      ...
      <main className="max-w-2xl mx-auto py-12 px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-base leading-relaxed">
            Hey! Tired of guessing your liters? Use this quick boad recommender with wave height adjustments and conditions along with 50+ board models—to dial in the exact board you need for your next session.
          </p>
        </div>
